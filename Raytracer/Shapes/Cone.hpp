...
private:
  ...
  glm::dvec3 base_Q_;              // centre of base ellipse
  glm::dvec3 axis_w_;              // unit vector from base to apex
  glm::dvec3 b_u_, b_v_;           // semi‑axes of the base ellipse
  double     h_;                   // height
  double     r_u_, r_v_;           // semi‑axes lengths of the base ellipse
};